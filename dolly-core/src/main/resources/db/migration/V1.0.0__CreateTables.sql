...
CREATE TABLE T_BESTILLING_PROGRESS (
  BESTILLING_PROGRESS_ID NUMBER(9) NOT NULL,
...
CREATE TABLE T_KODEVERK_FIELDS (
...
ALTER TABLE T_BESTILLING_PROGRESS
  ADD CONSTRAINT BESTILLING_TILHORER_FK FOREIGN KEY (BESTILLING_ID) REFERENCES T_BESTILLING (BESTILLING_ID);
...
ALTER TABLE T_BRUKER_FAVORITTER
  ADD CONSTRAINT FAVORITTER_GRUPPER_FK FOREIGN KEY (TESTGRUPPE_ID) REFERENCES T_TESTGRUPPE (ID);
...
CREATE SEQUENCE T_KODEVERK_FIELDS_SEQ START WITH 1;
