package no.nav.dolly.synt.tilleggsstonad.config;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Syntetisering - Tilleggsstonad",
                description = "Applikasjonen genererer syntetiske Arena Tilleggsstonad-vedtak.",
                version = "1.0",
        ...
        tags = @Tag(
                ...
                externalDocs = @ExternalDocumentation(
                        ...
                        url = "https://navikt.github.io/testnorge-syntetiseringspakker/apps/arena/synt_tilleggsstonad/docs/Implementasjon.html"
                )
        )
)
@SecurityScheme(
