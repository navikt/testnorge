...
@NoArgsConstructor
@AllArgsConstructor
public class AatforAaunguforFriMkVedtakDto {

    @JsonProperty("AVVBRUDDSKODE")
    private String avvbruddskode;
    ...
    @JsonProperty("UTLANDSMOTTAKER")
    private String utlandsmottaker;
