...
@Component
public class PeriodeWsConverter implements Converter<PeriodeTo, no.udi.mt_1067_nav_data.v1.Periode> {
	...
	@Override
	public no.udi.mt_1067_nav_data.v1.Periode convert(PeriodeTo periode) {
		if (periode != null) {
