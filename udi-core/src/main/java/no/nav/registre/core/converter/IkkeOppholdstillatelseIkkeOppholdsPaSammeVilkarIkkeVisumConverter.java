...
public class IkkeOppholdstillatelseIkkeOppholdsPaSammeVilkarIkkeVisumConverter
		implements Converter<Person, IkkeOppholdstillatelseIkkeOppholdsPaSammeVilkarIkkeVisum> {
	...
	private OvrigIkkeOpphold getOvrigIkkeOpphold(IkkeOppholdstilatelseIkkeVilkaarIkkeVisum ikkeOpphold) {
