...
public class XmlGregorianCalendarCustomMapping extends BidirectionalConverter<XMLGregorianCalendar, LocalDateTime> {
    ...
    @Override public LocalDateTime convertTo(XMLGregorianCalendar calendar, Type<LocalDateTime> type, MappingContext mappingContext) {
    ...
    @Override public XMLGregorianCalendar convertFrom(LocalDateTime dateTime, Type<XMLGregorianCalendar> type, MappingContext mappingContext) {
