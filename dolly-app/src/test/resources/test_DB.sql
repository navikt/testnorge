...
INSERT INTO TEAM_BRUKERE (TEAM_ID,BRUKER_ID) VALUES (1, 'S111111');
INSERT INTO TEAM_BRUKERE (TEAM_ID,BRUKER_ID) VALUES (1, 'S221313');
--TEAM og BRUKERs eierskapsforhold
SELECT * FROM TEAM_BRUKERE;
...
SELECT *
FROM T_BRUKER
  JOIN TEAM_BRUKERE ON TEAM_BRUKERE.BRUKER_ID = T_BRUKER.NAV_IDENT
  JOIN T_TEAM ON T_TEAM.ID = TEAM_BRUKERE.TEAM_ID
