...
public class BestillingArenaforvalterStatusMapperTest {
    ...
    private static final List<BestillingProgress> RUN_STATUS = newArrayList(
            BestillingProgress.builder().ident("IDENT_1")
                    .arenaforvalterStatus("FolkeregisterIdent&status: Feil (404 Not Found - message: \"\n"
                            + "            + \"Feil ved henting)\"\n"
    ...
    public void buildArenaForvalterStatusMap() {
        ...
        List<RsMeldingStatusIdent> identStatuses = BestillingArenaforvalterStatusMapper.buildArenaforvalterStatusMap(RUN_STATUS);
