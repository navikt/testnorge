...
public class TestgruppeControllerTest {
    ...
    public void oppretteIdentBestilling() {
        ...
        when(bestillingService.saveBestilling(GRUPPE_ID, ant, envir, null, null, null)).thenReturn(bestilling);
    ...
    public void oppretteIdentBestillingFraEksisterende() {
        ...
        when(bestillingService.saveBestilling(GRUPPE_ID, 1, envir, null, null, newArrayList(IDENT))).thenReturn(bestilling);
