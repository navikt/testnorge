...
public class DollySyntPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        project.setGroup("no.nav.testnav.synt");
        ...
        configurations.configureEach(configuration -> {
            var exclusion1 = new HashMap<String, String>();
            exclusion1.put("group", "com.vaadin.external.google");
            exclusion1.put("module", "android-json");
            configuration.exclude(exclusion1);

            var exclusion2 = new HashMap<String, String>();
            exclusion2.put("group", "io.swagger.core.v3");
            exclusion2.put("module", "swagger-annotations");
            configuration.exclude(exclusion2);
        });
