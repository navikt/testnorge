...
import './InputAutocompleteField.css';
...
export default class InputAutocompleteField extends Component {
    constructor(props, context) {
        ...
        InputAutocompleteField.capitalizeFirstLetter = InputAutocompleteField.capitalizeFirstLetter.bind(this);
    ...
    optionsRenderer = (option) => {
        ...
        return (
            <div className="option-container" data-flex data-layout="row" data-layout-align="start center">
