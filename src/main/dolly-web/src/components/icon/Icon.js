...
export default class Icon extends PureComponent {
	...
	getIcon(kind) {
		...
		switch (kind) {
			...
			case ('file-new-lines'): return (<svg {...props} className={cn('svg-icon-file-new-lines', className)} focusable="false" height={height || size} width={width || size} style={style} viewBox="0 0 24 24"><title>Ny fil med linjer</title><g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" fill="none"></g>
				...
				{/* <path d= "M 7.5 8 H 12 c 0.276 0 0.5 -0.224 0.5 -0.5 S 12.276 7 12 7 H 7.5 C 7.224 7 7 7.224 7 7.5 S 7.224 8 7.5 8 Z"/>
				<path d= "M 16.5 10 h -9 C 7.224 10 7 10.224 7 10.5 S 7.224 11 7.5 11 h 9 c 0.276 0 0.5 -0.224 0.5 -0.5 S 16.776 10 16.5 10 Z"/>
				<path d= "M 16.5 13 h -9 C 7.224 13 7 13.224 7 13.5 S 7.224 14 7.5 14 h 9 c 0.276 0 0.5 -0.224 0.5 -0.5 S 16.776 13 16.5 13 Z"/>
				<path d= "M 16.5 16 h -9 C 7.224 16 7 16.224 7 16.5 S 7.224 17 7.5 17 h 9 c 0.276 0 0.5 -0.224 0.5 -0.5 S 16.776 16 16.5 16 Z"/>
				<path d= "M 16.5 19 h -9 C 7.224 19 7 19.224 7 19.5 S 7.224 20 7.5 20 h 9 c 0.276 0 0.5 -0.224 0.5 -0.5 S 16.776 19 16.5 19 Z"/> */}
