...
public class RestToDBMapper {
    ...
    public static Inntektsmelding.InntektsmeldingBuilder map201809melding(RsInntektsmelding melding) {
        ...
        Inntektsmelding.InntektsmeldingBuilder tmp = Inntektsmelding.builder()
                ...
                .refusjonsbeloepPrMnd(melding.getRefusjon().flatMap(RsRefusjon::getRefusjonsbeloepPrMnd).orElse(null))
                ...
                .omsorgspengerDelvisFravaersListe(melding.getOmsorgspenger().flatMap(omsorgspenger -> omsorgspenger.getDelvisFravaersListe()
                        ...
                        .orElse(Collections.emptyList()))
                .omsorgHarUtbetaltPliktigeDager(melding.getOmsorgspenger().flatMap(RsOmsorgspenger::getHarUtbetaltPliktigeDager).orElse(null))
