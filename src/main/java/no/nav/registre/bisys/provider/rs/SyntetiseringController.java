...
public class SyntetiseringController {
  ...
  @Autowired private SyntetiseringService syntetiseringService;

  @LogExceptions
  @ApiOperation(
      value =
          "Her kan man starte generering av syntetiske bidragsmeldinger på personer i en gitt TPSF-avspillergruppe i et gitt miljø.")
