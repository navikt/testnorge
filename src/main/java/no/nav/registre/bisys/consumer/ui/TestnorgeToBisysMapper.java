...
public interface TestnorgeToBisysMapper {
  ...
  @Mapping(target = "boforholdBarnRegistrertPaaAdresse",
      source = "augments.boforholdBarnRegistrertPaaAdresse")
  @Mapping(target = "bidragsberegningKodeVirkAarsak",
      source = "augments.bidragsberegningKodeVirkAarsak")
  @Mapping(target = "bidragsberegningSamvarsklasse",
      source = "augments.bidragsberegningSamvarsklasse")
  @Mapping(target = "fatteVedtakGebyrBeslAarsakKode",
      source = "augments.fatteVedtakGebyrBeslAarsakKode")
