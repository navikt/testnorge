...
public class BisysUiRollerConsumer {
  ...
  private static final String BARN_NOT_ADDED_TO_SAK =
      "Barn with id %s was not added to existing sak %s";

  private final static String ERROR_BARN_MANGLER_RELASJON_TIL_BM_BP =
      "Barn med fødselsnummer %s mangler relasjon til angitt BM/BP";

  private final static String DUPLIKAT_SAK =
      "Det finnes allerede en sak med samme BM og BP på saksnr ";
