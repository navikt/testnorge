...
public class StaticFileService {
    ...
    private void readAaregLocalFile() {
        try {
            List<AaregModel> entities = (List<AaregModel>) (List<?>) DatabaseInitializer.initializeFromCsv("src/main/resources/statisk_data/aareg.csv", ModelEnum.AAREG, ";");
    ...
    private void readDkifLocalFile() {
        try {
            List<KrrModel> entities = (List<KrrModel>) (List<?>) DatabaseInitializer.initializeFromCsv("src/main/resources/statisk_data/dkif.csv", ModelEnum.DKIF, ";");
