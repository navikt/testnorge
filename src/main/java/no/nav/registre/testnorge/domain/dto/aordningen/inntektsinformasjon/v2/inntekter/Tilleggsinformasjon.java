package no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter;
...
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.BilOgBaat;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.BonusFraForsvaret;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.DagmammaIEgenBolig;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.Inntjeningsforhold;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.Livrente;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.LottOgPartInnenFiske;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.Nettoloennsordning;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.NorskKontinentalsokkel;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.Periode;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.ReiseKostOgLosji;
import no.nav.registre.testnorge.domain.dto.aordningen.inntektsinformasjon.v2.inntekter.tilleggsinformasjon.UtenlandskArtist;
