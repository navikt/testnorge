...
import no.nav.registre.syntrest.services.domains.EIAService;
...
public class EIAController extends RootController {
    ...
    public ResponseEntity generateEia(@RequestBody List<Map<String, String>> request) throws IOException, ApiException {
        ...
        return generate(appName, eiaService, request, counter, lock, counterLock);
    }
}
