...
import no.nav.registre.syntrest.services.domains.InntektService;
...
public class InntektController extends RootController {
    ...
    public ResponseEntity generateInntektsmeldinger(@RequestBody String[] fnrs) throws ApiException, IOException {
        ...
        return generate(appName, inntektService, fnrs, counter, lock, counterLock);
    }
}
