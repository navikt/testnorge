...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "SyntRest",
                "API for å generere syntetisk data fra synth-pakkene",
                "" + appVersion,
                "https://nav.no",
                new Contact("Fellesregistrene på NAV", "http://stash.devillo.no/projects/TREGPOCS/repos/syntrest/browse", null),
