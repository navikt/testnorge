...
public class Pasient {
    ...
    @JsonProperty String fastlege;
    @JsonProperty("nav_kontor") String navKontor;
    @JsonProperty Arbeidsgiver arbeidsgiver;
    ...
    private static class Addresse {
        ...
        @JsonProperty Fylke fylke;
        @JsonProperty("land_kode") String landKode;

        @Getter @Setter @AllArgsConstructor
        private static class Fylke {
            @JsonProperty String dn;
    ...
    private static class Arbeidsgiver {
        ...
        @JsonProperty String yrkesbetegnelse;
        @JsonProperty int stillingsprosent;
    }
}
