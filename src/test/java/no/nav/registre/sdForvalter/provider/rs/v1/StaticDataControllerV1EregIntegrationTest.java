...
public class StaticDataControllerV1EregIntegrationTest {
    @Autowired
    private MockMvc mvc;
    ...
    @Test
    public void should_only_get_EREGs_with_BEDR_or_AS() throws Exception {
        ...
        EregModel komn = createEregModel("888888883", "KOMN");

        eregRepository.saveAll(Arrays.asList(as, bedr, ans, enk, komn));
        ...
        assertThat(response.getListe()).containsOnly(new Ereg(as), new Ereg(bedr));
    }
