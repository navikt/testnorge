...
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.boutgift.Boutgift;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.dagligreise.DagligReise;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.flytting.Flytting;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.hjemreise.Hjemreise;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.laeremidler.Laeremiddel;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.reiseobligatorisksamling.ReiseObligatoriskSamling;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.reisestoenad.ReisestoenadArbeidssoeker;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.tilsyn.TilsynBarn;
import no.nav.testnav.libs.domain.dto.arena.testnorge.tilleggsstoenad.tilsyn.TilsynFamiliemedlemmer;
