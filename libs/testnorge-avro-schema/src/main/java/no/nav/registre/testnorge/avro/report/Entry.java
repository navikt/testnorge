...
public class Entry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static no.nav.registre.testnorge.avro.report.Entry.Builder newBuilder() {
    return new no.nav.registre.testnorge.avro.report.Entry.Builder();
  }
   ...
   * @return A new Entry RecordBuilder
   */
  public static no.nav.registre.testnorge.avro.report.Entry.Builder newBuilder(no.nav.registre.testnorge.avro.report.Entry.Builder other) {
    if (other == null) {
      return new no.nav.registre.testnorge.avro.report.Entry.Builder();
    } else {
      return new no.nav.registre.testnorge.avro.report.Entry.Builder(other);
    }
  }
   ...
   * @return A new Entry RecordBuilder
   */
  public static no.nav.registre.testnorge.avro.report.Entry.Builder newBuilder(no.nav.registre.testnorge.avro.report.Entry other) {
    if (other == null) {
      return new no.nav.registre.testnorge.avro.report.Entry.Builder();
    } else {
      return new no.nav.registre.testnorge.avro.report.Entry.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Entry>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.nav.registre.testnorge.avro.report.Entry.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.nav.registre.testnorge.avro.report.Entry other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.status)) {
        this.status = data().deepCopy(fields()[0].schema(), other.status);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.report.Entry.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.report.Entry.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.report.Entry.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.report.Entry.Builder clearDescription() {
      description = null;
