...
public class Hendelse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder newBuilder() {
    return new no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder();
  }
   ...
   * @return A new Hendelse RecordBuilder
   */
  public static no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder newBuilder(no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder other) {
    if (other == null) {
      return new no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder();
    } else {
      return new no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder(other);
    }
  }
   ...
   * @return A new Hendelse RecordBuilder
   */
  public static no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder newBuilder(no.nav.registre.testnorge.avro.hendelse.Hendelse other) {
    if (other == null) {
      return new no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder();
    } else {
      return new no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Hendelse>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.nav.registre.testnorge.avro.hendelse.Hendelse other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ident)) {
        this.ident = data().deepCopy(fields()[0].schema(), other.ident);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder setIdent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder clearIdent() {
      ident = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder setFom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder clearFom() {
      fom = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder setTom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder clearTom() {
      tom = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.nav.registre.testnorge.avro.hendelse.Hendelse.Builder clearType() {
      type = null;
