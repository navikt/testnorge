...
public class HodejegerenConsumer {
    ...
    public HodejegerenConsumer(@Value("${testnorge-hodejegeren.rest-api.url}") String hodejegerenServerUrl) {
        ...
        this.hentRelasjonerUrl = new UriTemplate(hodejegerenServerUrl + "/v1/relasjoner-til-ident?ident={ident}&miljoe={miljoe}");
    }
    ...
    public List<String> finnFoedteIdenter(Long avspillergruppeId) {
        ...
        if (response.getBody() != null) {
            ...
            log.error("HodejegerenConsumer.finnFoedteIdenter: Kunne ikke hente response body fra Hodejegeren: NullPointerException");
        }
    ...
    public RelasjonsResponse hentRelasjonerTilIdent(String ident, String miljoe) {
        ...
        if (response.getBody() != null) {
            ...
            log.error("HodejegerenConsumer.hentRelasjonerTilIdent: Kunne ikke hente response body fra Hodejegeren: NullPointerException");
        }
