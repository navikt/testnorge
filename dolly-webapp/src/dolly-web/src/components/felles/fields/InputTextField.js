...
const InputTextFeild = ({
	...
	if (patternMismatch()) {
		patternError = true
		feilmeldingHtml = (
			<div className="skjemaelement__feilmelding" aria-live="assertive" role="alert">
				{patternFeilmelding}
			</div>
		)
	}
	...
	return (
		<div className="skjemaelement input-text-field-container">
			...
			<input
				className={'skjemaelement__input ' + (patternError ? 'skjemaelement__input--harFeil' : '')}
				id={id}
				name={name}
				value={value}
