        ...
        if (isNull(tpsPerson.getPersondetalj())) {
            ...
            if (!personer.isEmpty()) {
                ...
                tpsPerson.getPersondetalj().getRelasjoner().forEach(relasjon -> {
                    if ("PARTNER".equals(relasjon.getRelasjonTypeNavn()) && UKJENT.equals(partnere.next().getKjonn())) {
                        relasjon.getPersonRelasjonMed().setKjonn(UKJENT);
                    } else if ("BARN".equals(relasjon.getRelasjonTypeNavn()) && UKJENT.equals(barn.next().getKjonn())) {
                        relasjon.getPersonRelasjonMed().setKjonn(UKJENT);
                    }
                });
            }
