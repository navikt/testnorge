...
public class TpsfService {
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_getEnvironments" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_deletePersons" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_createAliases" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_checkEksisterendeIdenter" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_opprettIdenter" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_sendIdenterTilMiljoe" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_hentTestpersoner" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_leggTIlPaaPerson" })
    ...
    @Timed(name = "consumer", tags = { "operation", "tpsf_relasjonPerson" })
