...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    @Bean
    public Docket api() {
        HashSet contentTypeJson = new HashSet(Collections.singletonList("application/json"));
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "" + appVersion,
                "https://nav.no",
                new Contact("Fellesregistrene på NAV", "http://stash.devillo.no/projects/FEL/repos/testnorge-sigrun/browse", null),
