package no.nav.testnav.proxies.skattekortproxy;
...
public class SkattekortProxyApplicationStarter {

    private static final String[] miljoer = new String[]{"q1", "q2", "qa", qx"};
