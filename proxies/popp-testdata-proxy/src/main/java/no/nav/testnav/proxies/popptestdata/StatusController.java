...
public class StatusController {
    private static final String TEAM = "Team Pensjon Opptjening (POPP)";
    ...
    public Map<String, Map<String, String>> getStatus() {
        ...
        var status = checkConsumerStatus(
                "https://popp-testdata.dev.intern.nav.no/internal/isalive",
                "https://popp-testdata.dev.intern.nav.no/internal/isready",
                statusWebClient);
        status.put("team", TEAM);

        return Map.of(
                "popp-testdata", status
        );
    }
