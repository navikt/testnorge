...
public class SokosPostCommand implements Callable<Mono<String>> {
    ...
    private static final String SOKOS_URL = "/api/v1/person/opprett";
    ...
    public Mono<String> call() {
        log.info("Sender skattekort til Sokos for fnr: {}, inntektsår: {}",
                request.getFnr(), request.getSkattekort().getInntektsaar());
