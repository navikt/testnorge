...
public class RsInntektsmelding {
    ...
    public Optional<List<RsNaturaYtelseDetaljer>> getOpphoerAvNaturalytelseListe() {
        return Optional.ofNullable(opphoerAvNaturalytelseListe);
    }

    public Optional<List<RsNaturaYtelseDetaljer>> getGjenopptakelseNaturalytelseListe() {
