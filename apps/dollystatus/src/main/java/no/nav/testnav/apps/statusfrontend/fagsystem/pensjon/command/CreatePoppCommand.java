...
import no.nav.testnav.apps.statusfrontend.fagsystem.pensjon.PoppInntektRequest;
...
public class CreatePoppCommand implements Callable<Mono<Void>> {

    private final WebClient webClient;
    private final String token;
    private final RunId runId;
    private final PoppInntektRequest request;
