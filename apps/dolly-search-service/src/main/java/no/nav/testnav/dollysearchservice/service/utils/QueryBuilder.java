...
import static no.nav.testnav.dollysearchservice.service.utils.AdresserUtils.addAdresserQueries;
import static no.nav.testnav.dollysearchservice.service.utils.AlderUtils.addAlderQueries;
import static no.nav.testnav.dollysearchservice.service.utils.IdentifikasjonUtils.addIdentifikasjonQueries;
import static no.nav.testnav.dollysearchservice.service.utils.NasjonalitetUtils.addNasjonalitetQueries;
import static no.nav.testnav.dollysearchservice.service.utils.RelasjonerUtils.addRelasjonerQueries;
import static no.nav.testnav.dollysearchservice.service.utils.StatusUtils.addStatusQueries;
