...
public class FagsystemQueryUtils {
    ...
    public static void addFagsystemQuery(BoolQuery.Builder queryBuilder, ElasticTyper type) {
        ...
        switch (type) {
            ...
            case ARBEIDSFORHOLD_FRILANS -> mustMatchQuery(queryBuilder,ARBEIDSFORHOLDTYPE, "frilanserOppdragstakerHonorarPersonerMm");
            case ARBEIDSFORHOLD_ORDINAERT ->mustMatchQuery(queryBuilder,ARBEIDSFORHOLDTYPE, "ordinaertArbeidsforhold");
            case ARBEIDSFORHOLD_MARITIMT -> mustMatchQuery(queryBuilder,ARBEIDSFORHOLDTYPE, "maritimtArbeidsforhold");
            case ARBEIDSFORHOLD_FORENKLET -> mustMatchQuery(queryBuilder,ARBEIDSFORHOLDTYPE, "forenkletOppgjoersordning");
