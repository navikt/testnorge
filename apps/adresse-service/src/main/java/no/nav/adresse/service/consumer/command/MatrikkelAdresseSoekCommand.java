...
public class MatrikkelAdresseSoekCommand implements Callable<Mono<MatrikkelAdresseResponse>> {
    ...
    @Override
    public Mono<MatrikkelAdresseResponse> call() {
        ...
        return webClient
                ...
                .retrieve()
                .bodyToMono(MatrikkelAdresseResponse.class);
    }
}
