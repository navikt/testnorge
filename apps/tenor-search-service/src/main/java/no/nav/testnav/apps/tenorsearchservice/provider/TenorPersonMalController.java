...
import no.nav.testnav.apps.tenorsearchservice.domain.OppdaterTenorPersonMalRequest;
...
import no.nav.testnav.apps.tenorsearchservice.service.TenorPersonMalService;
