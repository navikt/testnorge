...
import no.nav.testnav.apps.tenorsearchservice.domain.OpprettTenorPersonMalRequest;
...
import no.nav.testnav.apps.tenorsearchservice.domain.TenorPersonMalBrukerResponse;
import no.nav.testnav.apps.tenorsearchservice.domain.TenorPersonMalLagreResult;
import no.nav.testnav.apps.tenorsearchservice.domain.TenorPersonMalOversiktResponse;
import no.nav.testnav.apps.tenorsearchservice.domain.TenorPersonMalResponse;
import no.nav.testnav.apps.tenorsearchservice.domain.ValidertTenorPersonMal;
