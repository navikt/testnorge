...
import no.nav.registre.testnorge.domain.dto.namespacetps.BoadresseType;
import no.nav.registre.testnorge.domain.dto.namespacetps.DodType;
import no.nav.registre.testnorge.domain.dto.namespacetps.ForeldreansvarType;
import no.nav.registre.testnorge.domain.dto.namespacetps.GironummerType;
import no.nav.registre.testnorge.domain.dto.namespacetps.MigrasjonType;
import no.nav.registre.testnorge.domain.dto.namespacetps.NavnType;
import no.nav.registre.testnorge.domain.dto.namespacetps.OppholdstillatelseType;
import no.nav.registre.testnorge.domain.dto.namespacetps.PersonIdentStatusType;
import no.nav.registre.testnorge.domain.dto.namespacetps.PersonIdentType;
import no.nav.registre.testnorge.domain.dto.namespacetps.PersonInfoType;
import no.nav.registre.testnorge.domain.dto.namespacetps.PersonStatusType;
import no.nav.registre.testnorge.domain.dto.namespacetps.PostType;
import no.nav.registre.testnorge.domain.dto.namespacetps.PrioritertadresseType;
import no.nav.registre.testnorge.domain.dto.namespacetps.RelasjonType;
import no.nav.registre.testnorge.domain.dto.namespacetps.SivilstandType;
import no.nav.registre.testnorge.domain.dto.namespacetps.StatsborgerType;
import no.nav.registre.testnorge.domain.dto.namespacetps.TelefonJobbType;
import no.nav.registre.testnorge.domain.dto.namespacetps.TelefonMobilType;
import no.nav.registre.testnorge.domain.dto.namespacetps.TelefonPrivatType;
import no.nav.registre.testnorge.domain.dto.namespacetps.TelefonType;
import no.nav.registre.testnorge.domain.dto.namespacetps.TilleggType;
