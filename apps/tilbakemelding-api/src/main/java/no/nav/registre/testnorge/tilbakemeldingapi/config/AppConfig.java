...
import no.nav.registre.testnorge.libs.autodependencyanalysis.config.AutoConfigureDependencyAnalysisRegistration;
...
@Import({
        ...
        AutoConfigureDependencyAnalysisRegistration.class
})
