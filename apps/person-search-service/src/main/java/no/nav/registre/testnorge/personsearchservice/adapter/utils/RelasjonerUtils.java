                ...
                .ifPresent(value -> {
                    if (value > 0) {
                        ...
                        var script = new Script(
                                ScriptType.INLINE,
                                "painless",
                                "def relasjoner = doc['hentPerson.forelderBarnRelasjon'].value; if (relasjoner != null){ return relasjoner.filter(relasjon -> relasjon.relatertPersonsRolle == 'BARN').length == params.limit; } return false;",
