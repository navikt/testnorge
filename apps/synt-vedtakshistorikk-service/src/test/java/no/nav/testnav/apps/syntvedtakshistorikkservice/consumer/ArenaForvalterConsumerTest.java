...
class ArenaForvalterConsumerTest {
    ...
    private void stubArenaForvalterOpprettAapRettighet() {
        stubFor(post(urlPathMatching("/arena/api/v1/aap"))
                .willReturn(ok()
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(post(urlPathMatching("/arena/api/v1/aap115"))
                .willReturn(ok()
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(post(urlPathMatching("/arena/api/v1/aapungufor"))
                .willReturn(ok()
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(post(urlPathMatching("/arena/api/v1/aaptvungenforvaltning"))
                .willReturn(ok()
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(post(urlPathMatching("/arena/api/v1/aapfritakmeldekort"))
                .willReturn(ok()
                        .withHeader("Content-Type", "application/json")
