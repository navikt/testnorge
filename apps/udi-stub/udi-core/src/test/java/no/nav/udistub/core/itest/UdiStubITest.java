package no.nav.udistub.core.itest;
...
import static no.nav.udistub.core.DefaultTestData.TEST_DATE;
import static no.nav.udistub.core.DefaultTestData.TEST_FLYKTNINGSTATUS;
import static no.nav.udistub.core.DefaultTestData.TEST_INNREISEFORBUD;
import static no.nav.udistub.core.DefaultTestData.TEST_NAVN;
import static no.nav.udistub.core.DefaultTestData.TEST_OPPHOLDSTILLATELSE;
import static no.nav.udistub.core.DefaultTestData.TEST_OPPHOLDS_GRUNNLAG_KATEGORI;
import static no.nav.udistub.core.DefaultTestData.TEST_PERSON_ALIAS_FNR;
import static no.nav.udistub.core.DefaultTestData.TEST_PERSON_FNR;
import static no.nav.udistub.core.DefaultTestData.TEST_ovrigIkkeOppholdsKategori;
