package no.nav.testnav.apps.personexportapi.domain;
...
import no.nav.testnav.apps.personexportapi.consumer.dto.FoedselsdatoFraIdent;
import no.nav.testnav.apps.personexportapi.consumer.dto.HusbokstavEncoder;
import no.nav.testnav.apps.personexportapi.consumer.dto.KjoennFraIdent;
import no.nav.testnav.apps.personexportapi.consumer.dto.LandkodeEncoder;
import no.nav.testnav.apps.personexportapi.consumer.dto.Sivilstatus;
