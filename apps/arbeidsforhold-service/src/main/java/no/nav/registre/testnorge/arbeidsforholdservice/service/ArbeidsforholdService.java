...
public class ArbeidsforholdService {
    ...
    public List<ArbeidsforholdResponse> getArbeidsforhold(List<ArbeidsforholdDTO> arbeidsforholdDTO) {

        return mapperFacade.mapAsList(arbeidsforholdDTO, ArbeidsforholdResponse.class);
    }
}
