...
public class RequestUtils {
    ...
    public static RettighetFinnTiltakRequest getRettighetFinnTiltakRequest(String personident, String miljoe, NyttVedtakTiltak tiltaksdeltakelse) {
        ...
        var rettighetRequest = new RettighetFinnTiltakRequest(Collections.singletonList(vedtak));
        rettighetRequest.setPersonident(personident);
        rettighetRequest.setMiljoe(miljoe);
