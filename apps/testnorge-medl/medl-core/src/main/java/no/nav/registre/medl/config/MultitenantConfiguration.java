...
import no.nav.registre.medl.database.multitenancy.MultitenantDataSource;
...
public class MultitenantConfiguration {
     ...
     *
     * @return a datasource specific to the thread context (the environment defined in the requests)
     */
    @Bean
