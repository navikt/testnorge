package no.nav.testnav.pdlpersonopensearchservice.consumers;

import com.fasterxml.jackson.databind.JsonNode;
import lombok.extern.slf4j.Slf4j;
import no.nav.testnav.pdlpersonopensearchservice.consumers.command.ElasticDeleteCommand;
...
public class ElasticParamsConsumer {
    ...
    public Mono<String> oppdaterParametre(JsonNode parametere) {
        ...
        return new no.nav.testnav.pdlpersonopensearchservice.consumers.command.ElasticPutCommand(webClient, username, password, index, parametere).call();
    }
