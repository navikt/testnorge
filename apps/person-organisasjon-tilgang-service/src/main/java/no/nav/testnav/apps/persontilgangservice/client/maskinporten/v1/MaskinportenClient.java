package no.nav.testnav.apps.persontilgangservice.client.maskinporten.v1;
...
public class MaskinportenClient {
    ...
    public Mono<no.nav.testnav.apps.persontilgangservice.domain.AccessToken> getAccessToken() {
        return accessToken.map(no.nav.testnav.apps.persontilgangservice.domain.AccessToken::new);
    }
