...
public class MigrateDatabase implements InitializingBean {
    ...
    private final List<no.nav.identpool.dbmigration.MigrationService> migrationServices;
    ...
    public void afterPropertiesSet() {
        ...
        if (!whitelistRepository.findAllBy().isEmpty()) {
            ...
            migrationServices.forEach(no.nav.identpool.dbmigration.MigrationService::migrate);
