package no.nav.testnav.apps.bankkontoservice.util;

import lombok.SneakyThrows;
import lombok.experimental.UtilityClass;
import lombok.extern.slf4j.Slf4j;
import no.nav.testnav.apps.bankkontoservice.dto.EndringsmeldingRequest;
import no.nav.testnav.apps.bankkontoservice.dto.EndringsmeldingResponse;
