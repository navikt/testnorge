package no.nav.testnav.apps.bankkontoservice.mapper;

import ma.glasnost.orika.CustomMapper;
import ma.glasnost.orika.MapperFactory;
import ma.glasnost.orika.MappingContext;
import no.nav.testnav.apps.bankkontoservice.dto.BankkontoNorskRequest;
import no.nav.testnav.apps.bankkontoservice.dto.TpsSystemInfo;
