# Bankkonto-service
Bankkonto-service gir tilgang til Norsk bankkonto og Utlandsk bankkonto TPS meldinger.  

## Swagger
Swagger finnes under [/swagger](https://testnav-bankkonto-service.dev.intern.nav.no/swagger) -endepunktet til
applikasjonen.

## Lokal kjøring
Ha naisdevice kjørende og kjør BankkontoServiceApplicationStarter med følgende argumenter:
```
