...
public class MatrikkeladresseMappingStrategy implements MappingStrategy {
    ...
    public void register(MapperFactory factory) {
        ...
        factory.classMap(no.nav.testnav.libs.dto.adresseservice.v1.MatrikkeladresseDTO.class, MatrikkeladresseDTO.class)
                .customize(new CustomMapper<>() {
                    @Override
                    public void mapAtoB(no.nav.testnav.libs.dto.adresseservice.v1.MatrikkeladresseDTO kildeAdresse,
