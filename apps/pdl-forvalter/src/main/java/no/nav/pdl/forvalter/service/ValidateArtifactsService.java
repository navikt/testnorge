...
public class ValidateArtifactsService {
    ...
    public void validate(PersonDTO person) {
        ...
        Stream.of(
                ...
                validate(bostedAdresseService, person.getBostedsadresse()),
                validate(foedselService, person.getFoedsel(), person),
                validate(navnService, person.getNavn()),
                validate(oppholdsadresseService, person.getOppholdsadresse()),
                ...
                validate(kontaktAdresseService, person.getKontaktadresse()),
