...
public class AdresseServiceConsumer {
    ...
    private String historiskeKommunerMedNyttNavn(String kommunenavn) {
        ...
        return switch (kommunenavn) {
            ...
            case "Askim", "Eidsberg", "Hobøl", "Spydeberg", "Trøgstad" -> "Indre Østfold";
            case "Audnedal" -> "Lyngdal";
            case "Balestrand", "Leikanger" -> "Sogndal";
            case "Ballangen", "Tysfjord" -> "Narvik";
            ...
            case "Fet", "Skedsmo", "Sørum" -> "Lillestrøm";
            case "Finnøy", "Rennesøy" -> "Stavanger";
            case "Fjell", "Sund" -> "Øygarden";
            case "Flora", "Vågsøy" -> "Kinn";
