...
import static no.nav.testnav.libs.data.pdlforvalter.v1.OppholdDTO.OppholdType.MIDLERTIDIG;
import static no.nav.testnav.libs.data.pdlforvalter.v1.OppholdDTO.OppholdType.OPPLYSNING_MANGLER;
