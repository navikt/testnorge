...
import no.nav.testnav.libs.data.pdlforvalter.v1.KontaktinformasjonForDoedsboDTO.OrganisasjonDTO;
...
import static no.nav.testnav.libs.data.pdlforvalter.v1.KontaktinformasjonForDoedsboDTO.KontaktpersonDTO;
import static no.nav.testnav.libs.data.pdlforvalter.v1.KontaktinformasjonForDoedsboDTO.PdlSkifteform.OFFENTLIG;
import static no.nav.testnav.libs.data.pdlforvalter.v1.KontaktinformasjonForDoedsboDTO.PersonNavnDTO;
