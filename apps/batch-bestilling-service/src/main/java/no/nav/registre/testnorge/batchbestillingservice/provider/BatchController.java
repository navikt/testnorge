...
public class BatchController {
    ...
    public String sendBatchBestilling(@RequestBody RsDollyBestillingRequest request,
        ...
        return batchBestillingService.sendBestillinger(gruppeId, request, antallPerBatch, delayInMinutes);
    }
}
