...
public class BatchController {
    ...
    public Mono<Void> sendBatchBestilling(@RequestBody RsDollyBestillingRequest request,
        ...
        return batchBestillingService.sendBestillinger(gruppeId, request, antallIdenterPerBatch, antallBatchJobber, delayInMinutes);
    }
}