package no.nav.registre.testnorge.batchbestillingservice.meter;
...
public class BatchBestillingWebClientTagsProvider implements WebClientExchangeTagsProvider {
