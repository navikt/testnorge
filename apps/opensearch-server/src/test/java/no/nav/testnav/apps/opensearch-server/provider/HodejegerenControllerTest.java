...
import static no.nav.testnav.apps.hodejegeren.provider.HodejegerenController.MAX_ALDER;
import static no.nav.testnav.apps.hodejegeren.provider.HodejegerenController.MIN_ALDER;
...
import no.nav.testnav.apps.hodejegeren.service.Endringskoder;
