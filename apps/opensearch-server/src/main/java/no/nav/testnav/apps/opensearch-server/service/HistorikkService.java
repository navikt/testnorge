...
import no.nav.testnav.apps.hodejegeren.logging.LogEvent;
import no.nav.testnav.apps.hodejegeren.logging.LogEventDTO;
import no.nav.testnav.apps.hodejegeren.logging.LogService;
import no.nav.testnav.apps.hodejegeren.provider.requests.DataRequest;
import no.nav.testnav.apps.hodejegeren.provider.requests.HistorikkRequest;
import no.nav.testnav.apps.hodejegeren.provider.requests.skd.PersonDokumentWrapper;
import no.nav.testnav.apps.hodejegeren.service.utilities.PersonDokumentUtility;
...
import no.nav.testnav.apps.hodejegeren.logging.Level;
