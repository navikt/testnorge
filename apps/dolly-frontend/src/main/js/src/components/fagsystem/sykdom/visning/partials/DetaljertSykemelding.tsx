...
export const DetaljertSykemelding = ({
                                         sykemelding,
                                         idx
                                     }: SykemeldingDetaljert) => {
    console.log('sykemelding', sykemelding)
    return (
        <div key={idx} className="person-visning_content">
            <React.Fragment key={idx}>
                <div className="person-visning_content">
                    <TitleValue title="Startdato"
                                value={formatStringDates(sykemelding.startDato)}/>
                    <TitleValue
                ...
                <>
                    ...
                    <div className="person-visning_content">
                        <TitleValue title="Diagnose"
                                    value={sykemelding.hovedDiagnose.diagnose}/>
                        <TitleValue title="Diagnosekode"
                                    value={sykemelding.hovedDiagnose.diagnosekode}/>
                    </div>
                </>
                ...
                <>
                    ...
                    <div className="person-visning_content">
                        ...
                        />
                        <TitleValue title="Ident"
                                    value={sykemelding.helsepersonell.ident}/>
                        <TitleValue title="HPR-nummer"
                                    value={sykemelding.helsepersonell.hprId}/>
                        <TitleValue title="SamhandlerType"
                                    value={sykemelding.helsepersonell.samhandlerType}/>
                    </div>
                </>
                <>
                    <SykemeldingKategori>
                    ...
                    <div className="person-visning_content">
                        <TitleValue title="Navn"
                                    value={sykemelding.arbeidsgiver.navn}/>
                        <TitleValue
                        ...
                        <TitleValue
                            ...
                            value={sykemelding.arbeidsgiver.stillingsprosent}
                        />
                    </div>
                </>
                ...
                <>
                    ...
                    <div className="person-visning_content">
                        <TitleValue title="Tiltak fra Nav"
                                    value={sykemelding.detaljer.tiltakNav}/>
                        <TitleValue
