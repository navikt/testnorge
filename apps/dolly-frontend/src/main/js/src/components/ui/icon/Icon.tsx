...
import NewFile2 from '@/assets/icons/nav-ikoner/line/SVG/17-files/file-new-2.svg?raw'
import FileCode from '@/assets/icons/nav-ikoner/line/SVG/17-files/file-code.svg?raw'
