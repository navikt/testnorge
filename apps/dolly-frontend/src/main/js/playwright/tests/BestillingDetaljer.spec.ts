...
test.describe('Dolly Bestillingsdetaljer testing', () => {
	test('passes', async ({ page, context }) => {
		...
		await page
			...
			.first()
			.click()
		await page.getByTestId(CypressSelector.TOGGLE_VISNING_BESTILLINGER).click()
		...
		await page.getByTestId(CypressSelector.BUTTON_BESTILLINGDETALJER_GJENOPPRETT).click()
		await page.getByTestId(CypressSelector.BUTTON_BESTILLINGDETALJER_GJENOPPRETT_UTFOER).click()
		await page.getByTestId(CypressSelector.BUTTON_BESTILLINGDETALJER_OPPRETT_MAL).click()
		await page.locator('#malnavn').fill('Testmal')
		await page.getByTestId(CypressSelector.BUTTON_MALMODAL_LAGRE).click()
	})
})
