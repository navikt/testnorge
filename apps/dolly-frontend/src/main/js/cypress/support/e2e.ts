...
const spesifikkGruppe = new RegExp(/bestilling\/gruppe$/)
...
beforeEach(() => {
	...
	cy.intercept({ method: 'POST', url: remainingCallsResponseOk }, []).as('remaining_post')
	...
	cy.intercept({ method: 'POST', url: spesifikkGruppe }, { statusCode: 201, body: nyGruppeMock })
