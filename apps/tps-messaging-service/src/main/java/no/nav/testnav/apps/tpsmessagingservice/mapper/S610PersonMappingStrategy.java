...
import no.nav.testnav.libs.data.tpsmessagingservice.v1.SivilstandDTO;
import no.nav.testnav.libs.data.tpsmessagingservice.v1.StatsborgerskapDTO;
...
import static no.nav.testnav.libs.data.tpsmessagingservice.v1.MidlertidigAdressetypeDTO.GATE;
import static no.nav.testnav.libs.data.tpsmessagingservice.v1.MidlertidigAdressetypeDTO.PBOX;
import static no.nav.testnav.libs.data.tpsmessagingservice.v1.MidlertidigAdressetypeDTO.STED;
import static no.nav.testnav.libs.data.tpsmessagingservice.v1.MidlertidigAdressetypeDTO.UTAD;
