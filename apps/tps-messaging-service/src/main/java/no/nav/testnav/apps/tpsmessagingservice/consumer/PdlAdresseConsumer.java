...
import no.nav.testnav.apps.tpsmessagingservice.config.credentials.PdlServiceProperties;
import no.nav.testnav.apps.tpsmessagingservice.consumer.command.PdlAdresseSoekCommand;
import no.nav.testnav.apps.tpsmessagingservice.dto.GraphQLRequest;
import no.nav.testnav.apps.tpsmessagingservice.dto.PdlAdresseResponse;
