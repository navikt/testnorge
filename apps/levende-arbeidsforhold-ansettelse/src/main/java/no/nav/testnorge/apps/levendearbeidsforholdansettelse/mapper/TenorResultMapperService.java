package no.nav.testnorge.apps.levendearbeidsforholdansettelse.mapper;
/*
...
import no.nav.testnorge.apps.levendearbeidsforholdansettelse.domain.tenor.TenorOversiktResponse;
