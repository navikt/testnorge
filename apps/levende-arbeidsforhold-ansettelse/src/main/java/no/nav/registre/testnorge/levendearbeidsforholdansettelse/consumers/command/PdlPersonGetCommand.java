...
import no.nav.registre.testnorge.levendearbeidsforholdansettelse.consumers.GraphQLRequest;
...
import static no.nav.registre.testnorge.levendearbeidsforholdansettelse.consumers.TemaGrunnlag.GEN;
import static no.nav.registre.testnorge.levendearbeidsforholdansettelse.consumers.domain.CommonKeysAndUtils.DOLLY;
import static no.nav.registre.testnorge.levendearbeidsforholdansettelse.consumers.domain.CommonKeysAndUtils.HEADER_NAV_CONSUMER_ID;
import static no.nav.registre.testnorge.levendearbeidsforholdansettelse.consumers.pdl.graphql.PdlHeaders.HEADER_NAV_CALL_ID;
