...
import lombok.val;
import no.nav.registre.testnorge.levendearbeidsforholdansettelsev2.consumers.command.PdlBolkPersonCommand;
import no.nav.registre.testnorge.levendearbeidsforholdansettelsev2.consumers.command.PdlPersonGetCommand;
