package no.nav.testnav.apps.syntaaregservice.util;

import com.fasterxml.jackson.databind.JsonNode;
import no.nav.testnav.apps.syntaaregservice.domain.aareg.*;
import no.nav.testnav.apps.syntaaregservice.exception.UkjentTypeException;
import no.nav.testnav.libs.domain.dto.aordningen.arbeidsforhold.*;
