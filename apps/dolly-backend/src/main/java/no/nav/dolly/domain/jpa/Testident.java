...
public class Testident implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(id, testident.id).append(versjon, testident.versjon).append(ident, testident.ident).append(iBruk, testident.iBruk).append(beskrivelse, testident.beskrivelse).append(testgruppe, testident.testgruppe).append(master, testident.master).append(bestillingProgress, testident.bestillingProgress).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(id).append(versjon).append(ident).append(iBruk).append(beskrivelse).append(testgruppe).append(master).append(bestillingProgress).toHashCode();
    }
