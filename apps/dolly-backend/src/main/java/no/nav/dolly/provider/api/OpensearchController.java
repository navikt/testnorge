...
public class OpensearchController {
    ...
    public SearchResponse getAll(@RequestBody(required = false) SearchRequest request) {

        return openSearchService.getAll(request);
    }
...
//
//        return openSearchService.getAll(ident);
//    }
//
    @GetMapping("/identer")
