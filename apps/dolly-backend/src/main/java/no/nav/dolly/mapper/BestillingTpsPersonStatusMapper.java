...
import static no.nav.dolly.domain.resultset.SystemTyper.TPS_STATUS;
...
public final class BestillingTpsPersonStatusMapper {

    public static List<RsStatusRapport> buildTpsPersonStatusMap(List<BestillingProgress> progressList) {
        ...
        return statusEnvIdents.isEmpty() ? emptyList() :
                singletonList(RsStatusRapport.builder().id(TPS_STATUS).navn(TPS_STATUS.getBeskrivelse())
