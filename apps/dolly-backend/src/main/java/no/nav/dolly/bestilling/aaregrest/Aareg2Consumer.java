...
import no.nav.dolly.bestilling.aaregrest.command.ArbeidsforholdGetCommand;
import no.nav.dolly.bestilling.aaregrest.command.ArbeidsforholdPostCommand;
import no.nav.dolly.bestilling.aaregrest.command.ArbeidsforholdPutCommand;
...
@Slf4j
@Component
public class Aareg2Consumer {

    private final WebClient webClient;
    private final ServerProperties serviceProperties;
    private final TokenExchange tokenService;

    public Aareg2Consumer(TestnavAaregisterProxyProperties serverProperties, TokenExchange tokenService, ObjectMapper objectMapper) {
