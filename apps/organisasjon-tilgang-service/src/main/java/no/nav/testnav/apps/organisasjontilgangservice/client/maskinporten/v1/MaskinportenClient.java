package no.nav.testnav.apps.organisasjontilgangservice.client.maskinporten.v1;
...
import no.nav.testnav.apps.organisasjontilgangservice.client.maskinporten.v1.command.GetAccessTokenCommand;
import no.nav.testnav.apps.organisasjontilgangservice.client.maskinporten.v1.command.GetWellKnownCommand;
