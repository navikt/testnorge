...
public class InntektsmottakerXmlInntekterRowMapper implements RowMapper<List<? extends Inntekt>> {
    ...
    @Override
    public List<? extends Inntekt> mapRow(ResultSet rs, int rowNum) throws SQLException {
