...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Testnav-TP-service",
                "Testnav-TP-service er integrasjonen mellom Orkestratoren og TJPEN databasen. Testnorge-TP går mot TJPEN i gitte miljøer",
                "" + appVersion,
                "https://nav.no",
                new Contact("Fellesregistrene på NAV", "https://github.com/navikt/testnorge/apps/tp-service", null),
