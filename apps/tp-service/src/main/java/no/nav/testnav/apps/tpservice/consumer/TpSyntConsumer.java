...
import no.nav.testnav.apps.tpservice.consumer.command.synt.GetSyntTpYtelserCommand;
import no.nav.testnav.apps.tpservice.consumer.credential.SyntTpProperties;
