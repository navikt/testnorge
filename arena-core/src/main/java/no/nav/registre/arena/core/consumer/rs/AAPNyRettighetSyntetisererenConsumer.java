...
public class AAPNyRettighetSyntetisererenConsumer {
    ...
    public AAPNyRettighetSyntetisererenConsumer(
    ...
    public List<AAPMelding> hentAAPMeldingerFraSyntRest(int numToGenerate) {
        RequestEntity getRequest = RequestEntity.get(uriTemplate.expand(numToGenerate)).build();
        ResponseEntity<List<AAPMelding>> response = restTemplate.exchange(getRequest, RESPONS_TYPE);
