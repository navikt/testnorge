...
public class HodejegerenConsumerTest {
    ...
    public void shouldFindLevendeIdenter() {
        stubHodejegerenConsumerFinnLevendeIdenter();

        List<String> levendeIdenter = hodejegerenConsumer.finnLevendeIdenter(avspillergruppeId);
    ...
    public void shouldLogOnEmptyResponseFindLevendeIdenter() {
        ...
        stubHodejegerenConsumerWithEmptyBody("/hodejegeren/api/v1/alle-levende-identer/" + avspillergruppeId);

        hodejegerenConsumer.finnLevendeIdenter(avspillergruppeId);
    ...
    private void stubHodejegerenConsumerFinnLevendeIdenter() {
        stubFor(get(urlPathEqualTo("/hodejegeren/api/v1/alle-levende-identer/" + avspillergruppeId))
                .willReturn(ok()
