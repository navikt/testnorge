...
public class TpsfConsumer {
    ...
    private static final ParameterizedTypeReference<RsPureXmlMessageResponse> RESPONSE_TYPE = new ParameterizedTypeReference<RsPureXmlMessageResponse>() {
    };
    ...
    public RsPureXmlMessageResponse sendEndringsmeldingTilTps(SendTilTpsRequest sendTilTpsRequest) {
        RequestEntity postRequest = RequestEntity.post(sendTilTpsUrl.expand()).body(sendTilTpsRequest);
