...
|link:https://github.com/navikt/testnorge/tree/master/proxies/dolly-proxy[dolly-proxy] |dev-fss |https://testnav-dolly-proxy.intern.dev.nav.no |detektert-histarkimport, detektert-inntektstub, detektert-sigrun-skd-stub, detektert-skjermede-personer, detektert-testnav-dolly-proxy, detektert-testnav-udi-stub |https://histarkimport.dev.intern.nav.no, https://inntektstub.intern.dev.nav.no, http://sigrun-skd-stub.team-inntekt.dev.intern.nav.no; http://sigrun-skd-stub.team-inntekt.svc.nais.local, https://skjermede-personer.dev.adeo.no; https://skjermede-personer.intern.dev.nav.no, https://testnav-dolly-proxy.dev-fss-pub.nais.io; https://testnav-dolly-proxy.intern.dev.nav.no, http://testnav-udi-stub.intern.dev.nav.no |true |aktiv
