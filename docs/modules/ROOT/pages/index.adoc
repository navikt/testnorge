...
|link:https://github.com/navikt/testnorge/tree/master/proxies/arena-forvalteren-proxy[arena-forvalteren-proxy] |dev-gcp |- |detektert-arena-ords-MILJOE |http://arena-ords-MILJOE.teamarenanais.svc.nais.local |false |aktiv
