...
Dette er en samlet dokumentasjon for applikasjoner, retningslinjer, svar på vanlige problemstillinger og støtteverktøy relatert til syntetiske testdata i Nav.
Spesifikke søk kan gjøres i søkefelt øverst til høyre.

[[dolly]]
== Dolly

Dolly er Navs selvbetjeningsløsning for å opprette og forvalte syntetiske testdata.
Med Dolly kan utviklingsteam raskt og enkelt opprette realistiske testpersoner med komplekse egenskaper, familiestrukturer og livsforløp – uten å berøre personopplysninger fra produksjon.

=== Hva er Dolly?

Dolly er et verktøy som gjør det mulig å:

* *Opprette syntetiske personer* med fødselsnummer, navn, adresse og demografiske data
* *Definere egenskaper og relasjoner* som arbeidsforhold, inntekt, familiemedlemmer, ytelser og mer
* *Deploy til testmiljøer* – distribuer testpersonene til valgte testmiljøer (Q1, Q2, etc.)
* *Gjenbruke testdata* – lagre bestillinger som maler for senere bruk
* *Samarbeide i team* – del og forvalt testdata sammen med teamet ditt

=== Hvorfor Dolly?

Testing med produksjonsdata medfører betydelig risiko og administrative byrder:

* Personvern og GDPR-utfordringer
* Kompleks tilgangsstyring og logging
* Sikkerhetskrav som begrenser fleksibilitet
* Tidkrevende prosesser for å få tilgang

Dolly løser disse utfordringene ved å tilby *fullstendig syntetiske data* som ikke kan spores tilbake til reelle personer.
Dette gir teamene frihet til å teste grundig uten personvernhensyn, samtidig som Nav overholder regelverket.

=== Hvem er Dolly for?

Dolly er primært laget for:

* *Utviklingsteam* som trenger testdata for utvikling og testing
* *Testere* som skal verifisere funksjonalitet på tvers av fagsystemer
* *Produkteiere* som ønsker å demonstrere funksjonalitet med realistiske data

Alle Nav-ansatte og konsulenter med tilgang kan bruke Dolly etter innlogging.

=== Kom i gang

Link til Dolly: https://dolly.ekstern.dev.nav.no/

Se xref:index.adoc#brukerveiledning[Brukerveiledning] for å lære hvordan du oppretter dine første testpersoner.

Har du spørsmål? Se xref:index.adoc#faq[Ofte stilte spørsmål (FAQ)] eller kontakt oss på Slack-kanalen #dolly.

Et omfattende eksempel på bestilling av tilgang til Dolly samt bruk av Dolly er tilgjengelig på team helsearbeidsgiver sine docs: https://github.com/navikt/sykepenger-im-lps-api/wiki/Testdata
...
Følg veiledningen under for å komme i gang.
...
image::dolly/opprettelse_prosess.png[Opprettelse prosess]
...
[[velg_identtype]]
===== Velg identtype, antall og gruppe

image::dolly/velg_ny_person.png[Velg ny person]

I dette vinduet velger du om du ønsker å opprette personer med nye identer eller om du ønsker å opprette personer med eksisterende identer.
Man kan også velge antall personer som skal opprettes og hvilken gruppe de skal legges til i, samt eventuell mal for bestillingen.
...
Velg miljø, og opprett en mal dersom denne bestillingen skal gjentas senere.
Kommentar kan brukes til å gjenkjenne identen senere, da denne vil vises ved hover i personlisten.
...
Denne funksjonaliteten lar deg legge til ekstra egenskaper på en eksisterende ident eller endre verdier på allerede eksisterende egenskaper.
...
++++
<figure>
  <video aria-label="Demo som viser legg til/endre funksjonalitet i Dolly" controls poster="_images/videos/legg-til-endre.png" style="max-width:730px">
    <source src="_images/videos/legg-til-endre.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++

[[flytte_identer]]
==== Flytte identer mellom grupper

Dolly har mulighet til å flytte identer mellom grupper ved å trykke "Flytt personer" i menyen under header på en gruppe.
Dette kan være nyttig hvis du ønsker å samle personer med lignende egenskaper i samme gruppe, eller ønsker at noen andre skal ta over eierskap til visse identer.

image::dolly/flytte_identer.png[Flytte identer]
...
++++
<figure>
  <video aria-label="Demo som viser flytting av identer i Dolly" controls poster="_images/videos/flytt-identer.png" style="max-width:730px">
    <source src="_images/videos/flytt-identer.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++
...
image::dolly/minside.png[Min side]

[[demo_maler]]
===== Demo - Opprette og bruke maler

++++
<figure>
  <video aria-label="Demo som viser mal-funksjonalitet" controls poster="_images/videos/maler-minside.png" style="max-width:730px">
    <source src="_images/videos/maler-minside.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++
...
Team gjør det mulig å samarbeide på de samme gruppene i Dolly.
Et team er en samling av Dolly-brukere som alle har tilgang på de samme dataene.
Du kan velge om du representerer deg selv eller et team.
Når du representerer et team vil alt du oppretter av grupper, personer og maler tilhøre teamet og ikke deg selv.

[[valg_representasjon]]
===== Valg av representasjon

Brukermenyen øverst til høyre viser deg selv og alle team du er medlem av.
Når du velger et team endres visninger som mine grupper til å heller vise teamets grupper.
Øverst til høyre ser du alltid hvem du representerer.

[[team_oversikt]]
===== Team-oversikt

I brukermenyen finnes nå ett nytt valg for team-oversikt.
Denne siden viser alle team du er medlem av og lar deg forlate, redigere og slette team.

Her kan du:
* Opprette nye team * Slette team du eier som ikke har medlemmer eller data * Legge til eller fjerne medlemmer i team du er medlem av * Bli med i eller forlate eksisterende team.

[[opprette_nytt_team]]
===== Opprette nytt team

1. Åpne Team-oversikt
2. Velg Opprett team
3. Fyll inn navn og beskrivelse
4. Legg til medlemmer (kan eventuelt gjøres senere)
5. Lagre

Dette teamet kan nå velges ved å trykke på brukernavnet ditt øverst til høyre og velge team isteden.
Mens du representerer teamet lagres nye grupper, personer og maler på teamet.

[[bli_med_eksisterende_team]]
===== Bli med i eksisterende team

1. Åpne Team-oversikt
2. Velg Bli med i team
3. Finn og velg team
4. Bekreft

Etter innmelding kan du på samme måte som over bytte representasjon til teamet fra brukermenyen.

[[demo_team_funksjonalitet]]
===== Demo: Team-funksjonalitet

++++
<figure>
  <video aria-label="Demo som viser team-funksjonalitet" controls poster="_images/videos/team-funksjonalitet.png" style="max-width:730px">
    <source src="_images/videos/team-funksjonalitet.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++
...
++++
<figure>
  <video aria-label="Demo som viser søk i Tenor og import av ident til Dolly" controls style="max-width:730px" poster="_images/videos/finnperson-tenor.png">
    <source src="_images/videos/finnperson-tenor.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++
...
[[demo_finnperson_tenor]]
===== Demo: Søk i Tenor og import til Dolly
...
++++
<figure>
  <video aria-label="Demo som viser oppretting av personer med tilfeldige verdier" controls poster="_images/videos/person-tilfeldige-verdier.png" style="max-width:730px">
    <source src="_images/videos/person-tilfeldige-verdier.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++
...
++++
<figure>
  <video aria-label="Demo som viser oppretting av personer med spesifikke verdier" controls poster="_images/videos/person-spesifikke-verdier.png" style="max-width:730px">
    <source src="_images/videos/person-spesifikke-verdier.mp4" type="video/mp4" >
    Din nettleser støtter ikke innebygde videoer.
  </video>
</figure>
++++
...
Dolly tilbyr mulighet til å opprette syntetiske testpersoner med:

* Grunnleggende persondata (navn, fødselsnummer, adresse, etc.)
* Familierelasjoner (ektefelle, barn, foreldre, etc.)
* Arbeidsforhold og inntekt
* Ytelser (sykepenger, foreldrepenger, etc.)
* Institusjonsopphold
* Fullmakter og vergemål
* Kontaktinformasjon
* og mye mer

Se xref:index.adoc#brukerveiledning[Brukerveiledning] for full oversikt over tilgjengelige egenskaper.

Savner du noe? Kontakt oss på Slack-kanalen #dolly eller epost dolly@nav.no.

[[faq_mangler_stoette]]
=== Dere har ikke lagt til rette for vårt behov - hva gjør vi?

Vi jobber kontinuerlig med å utvide Dolly basert på tilbakemeldinger fra brukere.

Hvis du mangler funksjonalitet:

1. Kontakt oss på Slack-kanalen #dolly
2. Beskriv ditt behov så konkret som mulig:
** Hva trenger du å teste?
** Hvilke egenskaper eller data mangler?
** Hvilke systemer skal dette brukes mot?
3. Vi vil vurdere behovet og prioritere utviklingen

Vi kan ikke alltid imøtekomme alle ønsker umiddelbart, men alle innspill hjelper oss å prioritere riktig.

[[faq_organisasjon_ansatte]]
=== Hvordan oppretter jeg en organisasjon med mange ansatte?

For å opprette en organisasjon med mange ansatte i Dolly:

1. Opprett først organisasjonen med ønsket organisasjonsnummer og egenskaper
2. Opprett deretter personer som skal være ansatte
3. Under egenskaper for personene, velg "Arbeidsforhold" og knytt dem til organisasjonens organisasjonsnummer
4. Du kan opprette flere personer samtidig og knytte dem alle til samme organisasjon

Tips: Bruk mal-funksjonalitet for å gjenbruke organisasjonsinformasjon når du oppretter flere ansatte.

[[faq_sikkerhetstiltak]]
=== Hvordan bruker jeg sikkerhetstiltak og adressebeskyttelse?

Mange brukere er usikre på forskjellen mellom sikkerhetstiltak og adressebeskyttelse:

* *Adressebeskyttelse (kode 6 og 7)*: Dette er offisielle beskyttelseskoder fra Folkeregisteret
** Kode 6: Strengt fortrolig adresse
** Kode 7: Fortrolig adresse
* *Sikkerhetstiltak*: Generelle sikkerhetstiltak som kan legges til personer. For eksempel: "Nav-ansatt skal aldri være alene med bruker (på grunn av voldshistorikk)". Sikkerhetstiltaket her er altså for den Nav-ansatte, ikke for brukeren.
* *Skjerming*: Brukes for å skjerme personer fra innsyn

Mange brukere velger "Sikkerhetstiltak" når de egentlig trenger "Adressebeskyttelse". Velg riktig kategori basert på testscenarioet ditt:

* Skal du teste håndtering av strengt fortrolige adresser → Bruk kode 6/7
* Skal du teste generelle sikkerhetstiltak → Bruk sikkerhetstiltak

[[faq_vergemaal_fullmakt]]
=== Hva er forskjellen på vergemål og fullmakt?

* *Vergemål*: En juridisk ordning der en person (verge) er oppnevnt av fylkesmannen til å ivareta interessene til en person som ikke kan ivareta egne interesser (f.eks. barn, personer med utviklingshemming)
* *Fullmakt*: En frivillig avtale der en person gir en annen person rett til å handle på sine vegne i spesifikke situasjoner

I Dolly kan du legge til begge:

* For vergemål: Velg "Vergemål" under egenskaper
* For fullmakt: Velg "Fullmakt" under egenskaper

[[faq_prodlast]]
=== Hvorfor er testpersonene mine borte etter prodlast?

Testpersoner kan forsvinne etter en prodlast (migrering av data fra produksjon til testmiljø). Dette skyldes at prodlasten overskriver data i testmiljøet.

Spesielt viktig å merke seg:

* *Arena*: Ved datamigreringsaktiviteter i Arena kan syntetiske personer bli overskrevet
* Følg med på varsler i kanalen #datamigrering for planlagte prodlaster
* Hvis personene dine er borte etter en prodlast, må de opprettes på nytt

Hva kan du gjøre?

* *Gjenopprett gruppe* – det beste tiltaket etter en prodlast. Gå til gruppen din og klikk "GJENOPPRETT" i gruppeheaderen. Da lastes alle personene i gruppen inn på nytt til de valgte miljøene
* Lagre bestillingene som maler slik at du enkelt kan gjenskape personene
* Bruk Test-Norge personer som er mer stabile over tid
* Kontakt oss på #dolly hvis du har kritiske testpersoner som må bevares

[[faq_komplekse_relasjoner]]
=== Hvordan lager jeg komplekse familierelasjoner?

For å lage komplekse familierelasjoner i Dolly, for eksempel med partner og foreldreansvar:

1. Opprett hovedperson
2. Velg "Relasjoner" → "Ektefelle/Partner"
3. Du kan enten opprette ny partner eller velge eksisterende person
4. For å legge til barn: Velg "Relasjoner" → "Barn" eller "Foreldreansvar"
5. Barn kan også opprettes med begge foreldrene automatisk

Uten partner, men med foreldreansvar:

1. Opprett person som skal ha foreldreansvar
2. Opprett barn separat
3. Velg "Legg til/endre" på personen
4. Velg "Foreldreansvar" og knytt til barnet

Mer komplekse strukturer:

* Samboere uten formelt forhold
* Delt foreldreansvar
* Verge som ikke er forelder
* Flere generasjoner

For disse scenariene, bygg opp familien steg for steg ved å bruke "Legg til/endre" funksjonalitet og "Relasjoner". Se også xref:index.adoc#demo_legg-til-endre[Demo - Legg til/endre].

[[faq_altinn_dolly_samarbeidspartner]]
=== Hvorfor finner jeg ikke "Nav's Dolly for samarbeidspartnere" i Altinn?

Altinn lar deg velge "Hvem vil du bruke Altinn på vegne av", og det er organisasjonsnummer som Dolly har gitt tilgang for som benyttes. 

Fra Altinn, gjør som følger:

1. Velg *Tilgangsstyring* og *Brukere*
2. Opprett bruker eller velg en eksisterende, og i åpen personvisning velg *Enkelttjenester*
3. Velg *+ Gi fullmakt*, og søk etter tjeneste *Dolly*
4. Når denne er funnet → *+ Gi fullmakt* en gang til, og *Gi fullmakt* en gang til

Slik skal resultatet se ut når det har blitt lagt til riktig:

image::dolly/altinn_fullmakt_result.png[Skjermbilde av Altinn fullmakt-tjeneste for Dolly, role=bordered]
...
Format: tabell under genereres automatisk av script.
Kolonner:
...
|link:https://github.com/navikt/testnorge/tree/master/proxies/aareg-proxy[aareg-proxy] |dev-gcp |- |- |- |false |aktiv
...
|link:https://github.com/navikt/testnorge/tree/master/proxies/arena-forvalteren-proxy[arena-forvalteren-proxy] |dev-gcp |- |detektert-arena-forvalteren, detektert-arena-ords-MILJOE |http://arena-forvalteren.teamarenanais.svc.nais.local/, http://arena-ords-MILJOE.teamarenanais.svc.nais.local |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/batch-adeo-proxy[batch-adeo-proxy] |dev-gcp |- |- |- |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/brregstub-proxy[brregstub-proxy] |dev-gcp |- |- |- |false |aktiv
...
|link:https://github.com/navikt/testnorge/tree/master/proxies/dokarkiv-proxy[dokarkiv-proxy] |dev-gcp |- |detektert-dokarkiv-MILJOE |http://dokarkiv-MILJOE.teamdokumenthandtering.svc.nais.local |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/dolly-proxy[dolly-proxy] |dev-fss |https://testnav-dolly-proxy.intern.dev.nav.no |digdir-krr-stub |- |true |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/ereg-proxy[ereg-proxy] |dev-gcp |- |- |- |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/fullmakt-proxy[fullmakt-proxy] |dev-gcp |- |detektert-repr-fullmakt |http://repr-fullmakt.repr.svc.nais.local |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/histark-proxy[histark-proxy] |dev-gcp |- |- |- |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/inntektstub-proxy[inntektstub-proxy] |dev-gcp |- |- |- |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/inst-proxy[inst-proxy] |dev-gcp |- |detektert-opphold-testdata |http://opphold-testdata.team-rocket.svc.nais.local |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/kontoregister-person-proxy[kontoregister-person-proxy] |dev-gcp |- |detektert-sokos-kontoregister-person |https://sokos-kontoregister-person.intern.dev.nav.no |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/krrstub-proxy[krrstub-proxy] |dev-gcp |- |detektert-digdir-krr-stub |https://digdir-krr-stub.intern.dev.nav.no |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/medl-proxy[medl-proxy] |dev-gcp |- |detektert-medlemskap-medl-testdata |https://medlemskap-medl-testdata.intern.dev.nav.no |false |aktiv
...
|link:https://github.com/navikt/testnorge/tree/master/proxies/norg2-proxy[norg2-proxy] |dev-gcp |- |- |- |false |aktiv
...
|link:https://github.com/navikt/testnorge/tree/master/proxies/pensjon-testdata-facade-proxy[pensjon-testdata-facade-proxy] |dev-gcp |- |detektert-pensjon-testdata-facade |http://pensjon-testdata-facade.pensjontestdata.svc.nais.local; https://pensjon-testdata-facade.dev.intern.nav.no |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/saf-proxy[saf-proxy] |dev-gcp |- |detektert-saf-MILJOE |http://saf-MILJOE.teamdokumenthandtering.svc.nais.local |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/sigrunstub-proxy[sigrunstub-proxy] |dev-gcp |- |- |- |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/skjermingsregister-proxy[skjermingsregister-proxy] |dev-gcp |- |detektert-skjermede-personer |https://skjermede-personer.dev.adeo.no |false |aktiv
...
|link:https://github.com/navikt/testnorge/tree/master/proxies/trygdeetaten-nav-proxy[trygdeetaten-nav-proxy] |dev-gcp |- |detektert-synthdata-arena-meldekort |https://synthdata-arena-meldekort.intern.dev.nav.no |false |aktiv
|link:https://github.com/navikt/testnorge/tree/master/proxies/udistub-proxy[udistub-proxy] |dev-gcp |- |detektert-testnav-udi-stub |http://testnav-udi-stub.dolly.svc.nais.local |false |aktiv
