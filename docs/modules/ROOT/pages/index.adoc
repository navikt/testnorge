...
++++
<figure>
  <video aria-label="Demo som viser søk i Tenor og import av ident til Dolly" controls style="max-width:730px">
    <source src="{imagesdir}/videos/finnperson-tenor.mp4" type="video/mp4"/>
